...
#define LED_LEDC_CHANNEL_2  //Using different ledc channel/timer than camera
#define LED_LEDC_CHANNEL_0
...
#if CONFIG_LED_ILLUMINATOR_ENABLED
// Định nghĩa hàm enable_led
void enable_led(bool en) {  // Turn LED On or Off
    int duty = en ? 255 : 0;  // Bật hoặc tắt LED
    ledcWrite(LED_LEDC_CHANNEL_2, duty);  // Sử dụng kênh LEDC_CHANNEL_2
}
...
#include "driver/ledc.h"  // Thêm thư viện LEDC

#define LED_LEDC_CHANNEL_2 LEDC_CHANNEL_2  // Đảm bảo khai báo đúng kênh

void setupLedFlash(int pin) {
#if CONFIG_LED_ILLUMINATOR_ENABLED
  ledc_channel_config_t ledc_channel = {
    .gpio_num = pin,
    .speed_mode = LEDC_HIGH_SPEED_MODE,  // Tốc độ PWM cao
    .channel = LED_LEDC_CHANNEL_2,       // Kênh PWM bạn sử dụng
    .intr_type = LEDC_INTR_DISABLE,      // Không sử dụng ngắt
    .timer_sel = LEDC_TIMER_0,           // Sử dụng Timer 0
